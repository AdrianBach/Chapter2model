...
max_cell=1.5 # max expected number of preys of each kind per cell # if 2.5, between 2 and 3 animals per cell
...
prd_move_1=0.1  # argv[21] predator max movement range in fraction of size
prd_offs_1=1    # argv[23] predator max number of offspring
prd_intr_1=101  # argv[25] predator time of introduction in the model
...
pop_array=(10 100 1000) # hard coded for now
...
do
    ...
    printf "freq_snap = $freq_snap \t\t # argv[32] frequency of results measure\n\n" >> paramFile.txt
