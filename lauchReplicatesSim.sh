...
burn_time=1 # argv[28] time steps to burn before lauching regular survival and reproduction trials
freq_repr=1 # argv[29] frequency of reproduction trials
freq_surv=1 # argv[30] frequency of survival trials

# frequency of assessment
freq_snap=1 # argv[31] frequency of landscape snap shot
freq_rslt=1 # argv[32] frequency of results measure
...
do
    ...
    ./chapter2ibm.o $sim_name $size $res_nb $max_res_1 $max_res_2 $pry_nb $pry_init_1 $pry_init_2 $pry_move_1 $pry_move_2 $pry_cons_1 $pry_cons_2 $pry_surv_1 $pry_surv_2 $pry_offs_1 $pry_offs_2 $pry_repr_1 $pry_repr_2 $prd_nb $prd_init_1 $prd_move_1 $prd_cons_1 $prd_conv_1 $prd_surv_1 $prd_offs_1 $prd_repr_1 $simu_time $burn_time $freq_repr $freq_surv
