...
echo "prdCtchProbaArray is ${prdCtchProbaArray[*]}"
echo "prdCtchProbaArray size is ${#prdCtchProbaArray[@]}"

# loop over maxCell
for ((i=0 ; i<${#pryMaxCellArray[@]} ; i++))
do
    max_cell=${pryMaxCellArray[$i]} 

    ## calculate parameter values accordingly ##
