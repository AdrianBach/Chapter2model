...
ratioArray=(1 1.5 2 2.5 3 3.5 4 4.5 5)
# spcfArray=(0 1 0)
# oprtArray=(0 0 1) 
...
#     prd_oprt_1=${oprtArray[$i]} 
    ...
    do
        prd_ctch_pry2_1=`echo "scale=0; ${ratioArray[$k]}*$prd_ctch_pry1_1" | bc`;

        echo "predators specific: $prd_spcf_1 ; predators oportunist: $prd_oprt_1 ; prey2 to prey1 catch proba ratio : ${ratioArray[$k]}"

        # name the simulation with only the variables of interest and their value
        sim_name="doubleCatchProba-onePrey-pryCatchProbaRatio${ratioArray[$k]}" # argv[1]
