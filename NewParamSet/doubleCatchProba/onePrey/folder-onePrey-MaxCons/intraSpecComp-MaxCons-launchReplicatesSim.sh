...
ratioArray=(0.34 0.67 1 1.34 1.67 2)
# spcfArray=(0 1 0)
# oprtArray=(0 0 1) 
...
#     prd_oprt_1=${oprtArray[$i]} 
    ...
    do
        ...
        echo "predators specific: $prd_spcf_1 ; predators oportunist: $prd_oprt_1 ; prey2 to prey1 max consumption ratio : ${ratioArray[$k]}"

        # name the simulation with only the variables of interest and their value
        sim_name="doubleCatchProba-onePrey-pryMaxConsRatio${ratioArray[$k]}" # argv[1]
        ...
        cp intraSpecComp-chapter2ibm.o $sim_name/chapter2ibm.o
