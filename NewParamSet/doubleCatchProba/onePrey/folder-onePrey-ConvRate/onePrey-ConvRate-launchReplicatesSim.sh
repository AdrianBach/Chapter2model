...
#     prd_oprt_1=${oprtArray[$i]} 
    ...
    do
        ...
        # name the simulation with only the variables of interest and their value
        sim_name="doubleCatchProba-onePrey-predSpcf$prd_spcf_1-predOpnt$prd_oprt_1-pryConvRateRatio${ratioArray[$k]}-pryCtchProbRatio1-pryOfspRatio1-pryMaxConsRatio1" # argv[1]
